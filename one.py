...
def get_mails():
    while 1:
        try:
            mid = "AAMkAGVhODg2MTVjLTZmZDctNDYwNy04MzM4LTU1ZmY1YTg0MjRiZABGAAAAAADtG7bhzAI2QanixOSN6SRlBwAhbt_6XSU3TIpLTJkxaB0qAAAAAAEMAAAhbt_6XSU3TIpLTJkxaB0qAAKkIO1fAAA="
                ...
                while 1:
                    if flag == 0:
                        query = f"https://graph.microsoft.com/v1.0/users/{email}" \
                                f"/mailFolders/inbox/messages/{mid}"
                    flag = 1
